...
posted to #mangonote-dev on irc.libera.chat).
...
The "Mangonote Maintainer Team" is defined in this document as the following users:
- fluffypony
- mangonotemooo
- hyc
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Mangonote code or Mangonote's dependency code or Mangonote's potential/future dependency code or research which successfully implements Mangonote.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Mangonote Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Mangonote Maintainer Team.
