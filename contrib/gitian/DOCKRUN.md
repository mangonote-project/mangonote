...
*Setup instructions for a Gitian build of Mangonote using Docker.*
...
You'll also need to clone the mangonote repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/mangonote-project/mangonote.git
cd mangonote/contrib/gitian
```
...
* a fork of the [gitian.sigs](https://github.com/mangonote-project/gitian.sigs/) repo on your GitHub account.
