...
RUN	git clone https://github.com/mangonote-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/mangonote-project/mangonote
...
if [ ! -d sigs ]; then
	git clone https://github.com/mangonote-project/gitian.sigs.git sigs
	cd sigs
